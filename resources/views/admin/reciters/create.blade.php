<x-admin.layouts.app title="إضافة شيخ">
    <x-admin.breadcrumb :items="[['label' => 'الشيوخ', 'url' => route('admin.reciters.index')], ['label' => 'إضافة شيخ']]" />

    <h1 class="text-3xl font-bold text-white mb-8">إضافة شيخ جديد</h1>

    <form method="POST" action="{{ route('admin.reciters.store') }}" enctype="multipart/form-data" class="max-w-2xl space-y-6">
        @csrf
